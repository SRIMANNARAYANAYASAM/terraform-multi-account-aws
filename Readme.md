...
Purpose of using Multi-Account AWS Architecture - Environment Isolation, Centralized Governance and Cross-Account Automation.
...
#### 1. Project Flowchart  
.  
![Project Flowchart](Diagram/Project-work-flow.jpg)
